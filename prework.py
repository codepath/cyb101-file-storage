...
def check_challenge(challenge_file, solution_hash):
    with open(challenge_file, 'rb') as file:
        ...
        if file_hash == solution_hash:
            ...
            print("🚧 You're close, but something isn't quite right. Please check your capitalization and try again.")
            return False
        elif file_strip_hash == solution_hash:
            print("🚧 You're close, but something isn't quite right. Please check for extra spaces and try again.")
            return False
        else:
